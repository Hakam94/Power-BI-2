...
>
> Here's what's real: in the Power BI Service, if you open a semantic model's Model view and switch to Editing mode, Copilot can now analyze your model, suggest fixes, rename tables and columns, create relationships, and generate DAX measures—all from natural language prompts, built directly into Power BI.
>
> And here's the part that actually matters most for everyone watching this specific channel: **that Copilot feature is not free.** It requires your organization to have a paid Microsoft Fabric capacity—F2 or higher, roughly $260 a month at the entry tier—or a Premium P1-or-higher capacity. A personal Power BI Pro license by itself does not unlock it. If you're a student, a freelancer, or working at a company that hasn't bought Fabric capacity, you almost certainly cannot use this feature at all, full stop.
>
> That's exactly why this entire video used Antigravity, a free coding agent, connected to your Power BI Project files through a free, local MCP server—zero organizational spend required. Everything we did today runs on your machine, works on any Power BI account, and costs nothing beyond Power BI Desktop itself, which is free. Native Copilot in Model view might genuinely be faster if your company is already paying for Fabric capacity—but for the free, build-it-yourself workflow this channel is about, what we walked through today is the one that's actually accessible to you."*
