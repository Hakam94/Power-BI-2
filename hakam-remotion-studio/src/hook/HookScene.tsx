...
import { SPEAKER_SAFE_ZONE } from '../components/SpeakerSafeZone';
...
export const HookScene: React.FC = () => {
  ...
  const badgeOpacity = interpolate(badgeFrame, [0, 8], [0, 1], { extrapolateRight: 'clamp' });
  ...
  const promptY = interpolate(promptFrame, [0, 15], [20, 0], { extrapolateRight: 'clamp' });
  ...
  const beamX = interpolate((frame % 60), [0, 60], [0, 520]);
  ...
  return (
    <div
      style={{
        position: 'absolute',
        left: SPEAKER_SAFE_ZONE.graphicsColumn.left,
        top: SPEAKER_SAFE_ZONE.graphicsColumn.top,
        width: SPEAKER_SAFE_ZONE.graphicsColumn.maxWidth,
        height: 900,
        pointerEvents: 'none',
      }}
    >
      {/* ── L1: MICROSOFT BUILD 2026 BADGE ── */}
      <div
        style={{
          position: 'absolute',
          top: 0,
      ...
      {/* ── L2: "تخيّل معي..." KINETIC TEXT REVEAL ── */}
      ...
      {/* ── L4: WORKFLOW ANIMATED DIAGRAM (8.3s) ── */}
